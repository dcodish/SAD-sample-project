...
**☁️ אם אתם על Azure SQL — שלב 11 לא רלוונטי לכם. אין מה לעשות.**
בסיס הנתונים שלכם משותף מהרגע הראשון, וגם אפליקציית ה-C# כבר מחוברת אליו (שלב 5.2).
הקבוצה כולה עובדת מול אותם נתונים, וזה נכון כבר מתחילת השיעור.

**💻 אם אתם על SQL Server מקומי — שלב 11 הוא בשבילכם.** עד עכשיו לכל אחד מכם היה
בסיס נתונים נפרד. השלב מסביר איך לעבור לבסיס נתונים אחד משותף ב-Azure SQL, כדי שתוכלו
לעבוד ולהדגים על אותם נתונים. ראו `LESSON_STEPS` שלב 11.
